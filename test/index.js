...
const fs = require("fs"); //fs digunakan untuk mengirimkan gambar, kepanjangan dari fs adalah filesystem
...
describe("API ENDPOINT TESTING", () => {
  ...
  it("Post Booking Page", (done) => {
    ...
    const dataSample = {
      ...
      firstName: "Rhe",
      lastName: "Dev",
      email: "rhenaldoaryap@gmail.com",
      phoneNumber: "081388395289",
      accountHolder: "Rhenaldo Arya",
      bankFrom: "Mandiri",
    };
    chai
      .request(app)
